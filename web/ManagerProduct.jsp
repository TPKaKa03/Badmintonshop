                        ...
                        <div class="col-sm-6">
                            ...
                            <form action="xuatExcelProductControl" method="get">
                                <button type="submit" class="btn btn-success">
                                    <i class="material-icons">&#xE147;</i> Xuất file Excel
                                </button>
                            </form>
                ...
                <div class="clearfix">
                    <div class="hint-text"> <div >
                            ...
                            <c:forEach begin="1" end="${endP}" var="i">
                                ...
                                <a class="list-unstyled"  href="manager?index=${i}">${i}</a>
                            </c:forEach>
                        </div>
                        <div>
                            <a href="Home"> Click me to return Home'page</a>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    <form action="add" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <input id="ckeditor" name="title" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Price</label>
