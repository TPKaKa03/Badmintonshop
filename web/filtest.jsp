                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="Home">Sản phẩm bán chạy </a></li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<!--                            <div style="display: flex; justify-content: center; align-items: center; flex-direction: row; text-align: center;">
                                <form id="f2" action="Home" method="POST" style="display: flex; justify-content: center; align-items: center; flex-direction: column; text-align: center;">
                        ...
                        <div >
                            <div >
                                <c:forEach begin="1" end="${endP}" var="i">
                                    <a class="list-unstyled"  href="Home?indexs=${i}">${i}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
