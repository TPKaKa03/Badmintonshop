 ...
 * @author ACER
 */
@WebServlet(name="Top5SPBanChay", urlPatterns={"/top10"})
public class Top5SPBanChay extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<NumberSP> listTop10Product = dao1.getTop5SanPhamBanChay();
